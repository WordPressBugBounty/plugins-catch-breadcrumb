				...
				<div id="dashboard" class="wpcatchtab nosave active">
					...
					<div id="go-premium" class="content-wrapper col-2">
						...
						<div class="content">
							...
							<a href="<?php esc_url('https://catchplugins.com/plugins/catch-breadcrumb-pro/'); ?>" target="_blank"><?php esc_html_e('Find out why you should upgrade to Catch Breadcrumb Premium »', 'catch-breadcrumb'); ?></a>
						</div> <!-- .Content -->
				...
				<div id="premium-extensions" class="wpcatchtab  save">
					<div class="about-text">
						...
						<p><?php esc_html_e('You are currently using the free version of Catch Breadcrumb.', 'catch-breadcrumb'); ?><br />
							<a href="<?php esc_url('https://catchplugins.com/plugins/'); ?>" target="_blank"><?php esc_html_e('If you have purchased from catchplugins.com, then follow this link to the installation instructions (particularly step 1).', 'catch-breadcrumb'); ?></a>
						</p>
					</div>
